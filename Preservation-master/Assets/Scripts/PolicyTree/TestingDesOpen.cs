...
public class TestingDesOpen : MonoBehaviour
{
    ...
    {
        if (TestingDescription != null)
        {

            //booleans for whether each policy is description is open or not
            bool isActive = TestingDescription.activeSelf;
            ...
            TestingDescription.SetActive(!isActive);

            //if the other policies are open
            if (incomeActive == true || priceActive == true || maskActive == true || schoolActive == true)
            {
