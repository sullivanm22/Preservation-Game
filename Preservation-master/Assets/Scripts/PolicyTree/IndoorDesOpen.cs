...
public class IndoorDesOpen : MonoBehaviour
{
    ...
    {
        if (IndoorDescription != null)
        {

            //booleans for whether each policy is description is open or not
            bool isActive = IndoorDescription.activeSelf;
            ...
            IndoorDescription.SetActive(!isActive);

            //if the other policies are open
            if (parksActive == true || over100Active == true || publicActive == true ||
