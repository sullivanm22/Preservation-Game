...
public class BusinessDesOpen : MonoBehaviour
{
    ...
    public void OpenPanel()
    {
        if (BusinessDescription != null)
        {
            ...
            bool isActive = BusinessDescription.activeSelf;
            ...
            BusinessDescription.SetActive(!isActive);
            ...
            if (indoorActive == true || over100Active == true || publicActive == true ||
                ...
                allFlightsActive == true || bordersActive == true || diningActive == true || parksActive == true)
            {
